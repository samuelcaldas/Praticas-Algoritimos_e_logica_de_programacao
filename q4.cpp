...
#define MAX_ALUNOS 50   /* Número maximo de alunos */

 /**
  * @struct Aluno
  * @brief Representa um aluno com nome, medias das disciplinas, media geral e classificação.
  */
typedef struct {
...
/**
 * @brief Função de comparação para qsort para ordenar alunos em ordem decrescente de media geral.
 *
